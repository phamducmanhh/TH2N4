        ...
        <div class="col col-lg-3 col-sm-12">
            ...
            <div>
                ...
                <ul class="footer-links">
                    <li><a href="?act=my_account" style="color:#D10024;"><i class="fa fa-user-o"
                                style="color:black;"></i> Tài Khoản Của Tôi</a></li>
                    <li><br></li>
                ...
                <form method="post">
                    <table width=100%>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="input" type="text" name="name" placeholder="Nhập họ tên"
                                        value="<?=$info['ten_kh']?>">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="input" type="tel" id="sdt" name="tel" placeholder="Nhập số điện thoại"
                                        value="<?=$info['phone']?>" onchange="checkPhone();">
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="input-checkbox">
                                        ...
                                        <div class="caption">
                                            <input type="text" id="pswd" style="display:none;"
                                                value=<?=$info['mat_khau']?>>
                                            <input class="input" id="passOld" type="password" name="passwordOld"
                                                placeholder="Nhập mật khẩu cũ" style="margin-bottom:5px;"
                                                onchange="checkPass(1);">
                                            <div style="color:red" id="tb1"></div>
                                            <input class="input" id="passNew1" type="password" name="passwordNew"
                                                placeholder="Nhập mật khẩu mới từ 6 đến 32 ký tự"
                                                style="margin-bottom:5px;" onchange="checkPass(2);">
                                            <div style="color:red" id="tb2"></div>
                                            <input class="input" id="passNew2" type="password" name="passwordNew2"
                                                placeholder="Nhập lại mật khẩu mới" onchange="checkPass(3);">
